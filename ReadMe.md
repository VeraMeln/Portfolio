...
| Название проекта | Описание | Используемые библиотеки | 
| :---------------------- | :---------------------- | :---------------------- |
|[Система оценки риска ДТП](carsharing)|Необходиом разработать систему, которая могла бы оценить риск ДТП по выбранному маршруту движения|**sqlalchemy**, **sklearn**, **lightgbm**, **catboost**, **matplotlib**, **seaborn**, **pandas**, **numpy**|
|[Прогнозирование температуры звезды](star_temperature)|Необходимо разработать нейронную сеть, которая поможет предсказывать абсолютную температуру на поверхности звезды.|**torch**, **sklearn**, **pandas**, **numpy**, **matplotlib**, **math**, **random**|
